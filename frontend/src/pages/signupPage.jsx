  ...
  return (
    <div className="h-full w-full max-w-[500px] bg-black text-white flex flex-col p-4 justify-between">
      ...
      <div className="flex flex-col w-full">
        <h1 className="text-4xl font-bold mb-15 sm:mb-8">Sign Up</h1>
        ...
        <form className="flex flex-col w-full" onSubmit={handleSubmit}>
          ...
          <div className="mb-4 w-full flex justify-between">
            <input 
              ...
              className="w-[48%] bg-white/15 text-white p-3 pr-0 rounded-md"
            />
            <input 
              type="text" 
              ...
              className="w-[48%] bg-white/15 text-white p-3 rounded-md"
            />
          </div>
          <div className="mb-4">
            <input 
          ...
          {/* Login Button */}
          <div className="self-center mt-8 sm:mt-4">
          ...
          <div className="mb-2 text-[11px] text-gray-500 w-full text-center">These Features will be coming soon</div>
          {/* Social Login Buttons */}
          <button type="button" className="bg-blue-600 text-white py-3 px-4 rounded-md mb-3 flex items-center justify-center cursor-pointer" onClick={() => alert("This feature is coming soon")}>
          ...
          <button type="button" className="bg-white text-black py-3 px-4 rounded-md flex items-center justify-center cursor-pointer" onClick={() => alert("This feature is coming soon")}>
